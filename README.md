...
Predictive models with machine learning techniques were developed with existing and future data collected by the university to identify and predict students that would enrol into the bootcamp to reduce manual efforts and increase efficiencies in reaching out.
